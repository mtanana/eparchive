    ...
    var swipey = {
        ...
        initSwipey: function(wrapperName, slideContainerName) {                        
            ...
            swipey.wrapper = document.getElementById(wrapperName);
            swipey.slideContainer = document.getElementById(slideContainerName);
            swipey.slides = swipey.slideContainer.getElementsByTagName("li");

            //for iPhone, the width and height
            swipey.preferredWidth = 800;
            swipey.preferredHeight = 600; //510 for android
            ...
            swipey.numPages=swipey.slides.length;
        ...
        moveHandler: function(event) {
           event.preventDefault();
            if (swipey.hasSwipeStarted) {
               ...
               // swipey.translate(swipey.distanceX + swipey.currentDistance);
            }            
        },
        ...
        endHandler: function(event) {
            ...
            {                       
                ...
                else if (swipey.distanceX <= -(swipey.preferredWidth / 4)) { //-160               
                    swipey.moveLeft();
                }
                else if (swipey.distanceX >= (swipey.preferredWidth / 4)) { //160            
                    swipey.moveRight();
        ...
        moveLeft: function() {            
            ...
            swipey.translate(swipey.currentDistance);
        },
        moveRight: function() {           
            swipey.currentDistance += swipey.preferredWidth;          
           // swipey.slideContainer.style.webkitTransitionDuration = 300 + "ms";
        ...
        comeBack: function() {                   
            //swipey.slideContainer.style.webkitTransitionDuration = 250 + "ms";
             swipey.setTransition(250);
           // swipey.slideContainer.style.webkitTransitionTimingFunction = "ease-out";
            //swipey.slideContainer.style.webkitTransform = "translate3d(" + swipey.currentDistance + "px, 0,0)";
            swipey.translate(swipey.currentDistance);
        },
        setTransition: function(time){
        	swipey.slideContainer.style.webkitTransitionDuration = time + "ms";
        	swipey.slideContainer.style.oTransitionDuration = time + "ms";
        	swipey.slideContainer.style.MozTransitionDuration = time + "ms";
        	
        	swipey.slideContainer.style.webkitTransitionTimingFunction = "ease-out";
        	swipey.slideContainer.style.oTransitionTimingFunction = "ease-out";
        	swipey.slideContainer.style.MozTransitionTimingFunction = "ease-out";
        },
        translate: function(distance){
        	swipey.slideContainer.style.transform = "translate(" + distance+ "px, 0)";
        	swipey.slideContainer.style.msTransform = "translate(" + distance + "px, 0)";
        	swipey.slideContainer.style.webkitTransform = "translate3d(" + distance + "px, 0,0)";  //translate 3d is harware accelerated on ipad
        	swipey.slideContainer.style.oTransform = "translate(" + distance + "px, 0)";
        	swipey.slideContainer.style.MozTransform = "translate(" + distance + "px, 0)";
        },
        pageRight:function(){
